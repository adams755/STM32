...
#define FCLK_SLOW() { hspi1.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_256; }	/* Set SCLK = slow */
#define FCLK_FAST() { hspi1.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_2; }	/* Set SCLK = fast */
